...
void test_read_model() {
    ...
    expect(!hoiv::adapter::move_target_ok(11590, 11604), "Romandy brigade is not the St. Gallen test move");
    ...
    expect(hoiv::adapter::move_target_ok(11623, 11604), "Swiss neighbor is a valid test move");
    expect(!hoiv::adapter::move_target_ok(11623, 11623), "same province is not a move");
    expect(!hoiv::adapter::move_target_ok(11623, 6945), "Afyon is not a Swiss test move");
